...
//
  //      compareToString();
    ...
    public static int compareToString() {
    ...
    public static int compareToStringIgnoreCase() {
        String firstString = "Test";
        String secondString = "test";
    ...
    public static int stringBuffer() {
        //with capacity
    ...
    public static boolean endsWithStr() {
    ...
    public static boolean equalsStr() {
        String str1 = "Test";
        Object str2 = "Test1";
    ...
    public static String getBytesStr() {
        String str1 = "Kiro";
    ...
    public static String internStr() {
        String str1 = "Test";
    ...
    public static String replaceFirstStr() {
